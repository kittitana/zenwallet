...
class Settings extends Component<Props, State> {
  ...
  toggleAutomaticallyCheckForUpdates = (autoUpdate) => {
    ...
    if (!autoUpdate) {
      autoUpdateStore.setAutoUpdateCheckIntervalToDaily()
    } else {
      autoUpdateStore.setAutoUpdateCheckIntervalToFiveMinutes()
    }
  }
  ...
  renderAutoUpdate() {
    const { autoUpdateEnabled } = this.props.autoUpdateStore
    return (
      <Flexbox className="row">
        <Flexbox flexDirection="column" className="description">
        ...
        <Flexbox flexDirection="column" className="actions">
          ...
          {!autoUpdateEnabled &&
            <Flexbox flexDirection="column" className="auto-update-wrapper">
              <button className="btn-block" onClick={this.checkForUpdates}>Check for updates</button>
            </Flexbox>}
        </Flexbox>
      </Flexbox>
    )
