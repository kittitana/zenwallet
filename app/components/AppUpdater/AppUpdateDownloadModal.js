...
function getModalNode(version: string, message: string, autoUpdateStore: AutoUpdateStore) {
  ...
  ReactDOM.render(<AppUpdateDownloadModal version={version} message={message} autoUpdateStore={autoUpdateStore} />, wrapper)
  return wrapper.firstChild
}

const appUpdateDownloadModal = (version: string, message: string, autoUpdateStore: AutoUpdateStore) => swal({
